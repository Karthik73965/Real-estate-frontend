...
export const Updatelisting = () => {
  ...
  return (
    <main className="p-3  max-w-4xl mx-auto ">
        <h1 className="uppercase  text-3xl font-semibold text-center my-7 ">Update listing  </h1>
        <form onSubmit={handlesubmit} className="flex flex-col gap-4 sm:flex-row">
          ...
          <div className="flex flex-col flex-1  gap-4">
            ...
            <button className=" text-center p-3 bg-slate-700 text-white rounded-lg uppercase hover:opacity-95 disabled opacity-80">UPdate listing </button>
